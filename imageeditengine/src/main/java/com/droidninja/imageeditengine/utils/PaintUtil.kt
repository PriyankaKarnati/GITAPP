...
object PaintUtil {
    ...
    private val SEMI_TRANSPARENT: String? = "#AAFFFFFF"
    private val DEFAULT_BACKGROUND_COLOR_ID: String? = "#B0000000"
    private const val DEFAULT_LINE_THICKNESS_DP = 3f
    private const val DEFAULT_CORNER_THICKNESS_DP = 5f
