...
class KeyboardHeightProvider(
    ...
    interface KeyboardHeightObserver {
        open fun onKeyboardHeightChanged(height: Int, orientation: Int)
    }

    companion object {
        /** The tag for logging purposes  */
        private val TAG: String? = "sample_KeyboardHeightProvider"
    }
    ...
    init {
        ...
        popupView = inflator.inflate(com.droidninja.imageeditengine.R.layout.popwindow, null, false)
