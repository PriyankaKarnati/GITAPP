...
import com.droidninja.imageeditengine.utils.ScaleGestureDetector.OnScaleGestureListener
...
internal class ScaleGestureDetector(private val mListener: OnScaleGestureListener) {
    ...
    internal interface OnScaleGestureListener {
         ...
         * greater than 0.01.
         */
        open fun onScale(view: View, detector: ScaleGestureDetector): Boolean
         ...
         * rest of the gesture.
         */
        open fun onScaleBegin(view: View, detector: ScaleGestureDetector): Boolean
         ...
         * retrieve extended info about event state.
         */
        open fun onScaleEnd(view: View?, detector: ScaleGestureDetector?)
    }
    ...
    private fun setContext(view: View, curr: MotionEvent) {
        ...
        mTimeDelta = curr.getEventTime() - prev.eventTime
    ...
    companion object {
        private val TAG: String? = "ScaleGestureDetector"
