...
class VerticalSlideColorPicker : View {
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        colorPickerBody = RectF(centerX - colorPickerRadius, borderWidth + colorPickerRadius,
                centerX + colorPickerRadius, viewHeight - (borderWidth + colorPickerRadius))
        val gradient = LinearGradient(0F, colorPickerBody!!.top, 0F, colorPickerBody!!.bottom, colors, null,
    ...
    interface OnColorChangeListener {
        open fun onColorChange(selectedColor: Int)
    }
}